 ...
 * 时 间：2017/9/5 10:10
 */
class Divider(private val dividerWidthDp: Float, @param:ColorRes private val colorRes: Int) :
    BaseItemDecoration() {
  private var dividerWidthPixel: Float = 0.toFloat()
  ...
  private fun drawVertical(canvas: Canvas, parent: RecyclerView) {
    ...
    for (i in 0 until childCount) {
      ...
      val top = bottom - dividerWidthPixel
  ...
  private fun drawHorizontal(canvas: Canvas, parent: RecyclerView) {
    ...
    for (i in 0 until childCount) {
      ...
      val left = right - dividerWidthPixel
      //mDivider.setBounds(left, top, right, bottom);
      //mDivider.draw(canvas);
      canvas.drawRect(left, top, right, bottom, paint!!)
    }
  ...
  override fun getItemOffsets(outRect: Rect, view: View, parent: RecyclerView,
    ...
    if (layout_type != LAYOUT_UNSPECIFIED) {
      ...
      dividerWidthPixel = (parent.context.resources.displayMetrics.density * dividerWidthDp).toInt()
        .toFloat()
    ...
    when (layout_type) {
      LAYOUT_VERTICAL -> {
        outRect.set(0, 0, 0, dividerWidthPixel.toInt())
        return // 线性 manager 简单处理
      }
      LAYOUT_HORIZONTAL -> {
        outRect.set(0, 0, dividerWidthPixel.toInt(), 0)
        return // 线性 manager 简单处理
      }
      /* ------------------ */
    ...
    var l = dividerWidthPixel / 2
    var t = dividerWidthPixel / 2
    var r = dividerWidthPixel / 2
    val b = dividerWidthPixel / 2
